...
export const Resume = () => {
    return(
        <div id="resume" className="resume-grid">
            ...
            <h1 style={{ color: 'black', fontSize:'40px', margin:'0'}}>More of my credentials.</h1>
            <h3 style={{color: 'grey', fontSize: '20px'}}>Below are my Work Experiences and Educational details.</h3>
            ...
            <div style= {{width: '70%'}}><Chrono hideControls="true" items={EDUCATION_DATA} mode={"VERTICAL"} theme={{primary: "#b31746", secondary: "white", cardBgColor: "whitesmoke", cardForeColor: "#b31746" }}>
                <div className="chrono-icons">
